...
from scripts.data.schema import Target, Annotation, BoundingBox
...
def parse_out_text_json_objects_to_target(
    ...
    coords_mode: str = "normalized",  # "absolute" or "normalized"
    ...
    for i, block in enumerate(candidate_blocks):
        ...
        for j, item in enumerate(parsed):
            ...
            try:
                x1, y1, x2, y2 = _convert_raw_box_to_pixel_bbox(box)
